...
import profilePic from "https://postimg.cc/tYGnhHm9"
    ...
    <div className="flex flex-wrap">
        <div className="w-full lg:w-7/12">
            <div className="flex flex-col items-centre lg:items-start">
                ...
                variants={container(0.5)}
                 initial="hidden"
                 animate="visible"
                 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Pranav Phadatare</motion.h1>
                <motion.span 
        ...
        <div className="w-full lg:w-5/12 lg:p-8 ">
            <div className="flex justify-center " >
                ...
                src={profilePic} alt="Pranav Phadatare" className="rounded-3xl"/>
            </div>
        </div>
    </div>
  </div>
